...
from chilestay.views import index, registro_inmueble, inmueble_list
from chilestay import views
from django.contrib.auth import views as auth_views
from chilestay.views import EditProfileView, CuentaView, filtrar_inmuebles
...
urlpatterns = [
    ...
    path('inmueble_list/', views.inmueble_list, name='inmueble_list'),
    path('calendario/', views.calendario, name='calendario'),
    path('mensajes/', views.mensajes, name='mensajes'),
    path('reservaciones/', views.reservaciones, name='reservaciones'),
    path('estadisticas/', views.estadisticas, name='estadisticas'),
    path('solicitar_certificacion/', views.solicitar_certificacion, name='solicitar_certificacion'),
    #A ESTO
    path('filtrar_inmuebles/', filtrar_inmuebles, name='filtrar_inmuebles'),

    #ESTO DEBE VOLVER SI NO FUNCIONA 
    # path('registro_inmueble/', views.registro_inmueble, name='registro_inmueble'),
